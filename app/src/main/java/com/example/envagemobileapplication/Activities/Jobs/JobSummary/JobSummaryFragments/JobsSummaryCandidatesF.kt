...
import com.example.envagemobileapplication.Activities.Jobs.JobSummary.JobSummaryFragments.JobSummaryCandidateFragments.JsCandidateF
import com.example.envagemobileapplication.Activities.Jobs.JobSummary.JobSummaryFragments.JobSummaryCandidateFragments.JsDropCandidateF
import com.example.envagemobileapplication.Activities.Jobs.JobSummary.JobSummaryFragments.JobSummaryCandidateFragments.JsOfferSendF
import com.example.envagemobileapplication.Activities.Jobs.JobSummary.JobSummaryFragments.JobSummaryCandidateFragments.JsOnlineApplicantsF
            ...
            itemView.setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View) {
                    ...
                    if (clickedText == "Dropped Candidates") {
                        replaceFragment(JsDropCandidateF())
                    } else if (clickedText.equals("Offer sent")) {
                        replaceFragment(JsOfferSendF())
                    } else if (clickedText.equals("Online Applicants")) {
                        replaceFragment(JsOnlineApplicantsF())
                    } else if (clickedText.equals("Candidates")) {
                        replaceFragment(JsCandidateF())
                    }
                }
            })
